...
\begin{itemize}
\item Bicarbonate buffer system \ce{CO2 + H2O \rightleftharpoons H2CO3 \rightleftharpoons HCO3- + H+}
\item Phosphate buffer system \ce{H2PO4- + H2O \rightleftharpoons H3O+ + HPO4^2-}
\item Protein buffer system (amino acids can act as weak acids or bases)
\item Ammonia buffer system \ce{NH3 + H+ \rightleftharpoons NH4+}
\end{itemize}
\end{itemize}
